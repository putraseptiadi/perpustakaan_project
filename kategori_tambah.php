...
if (isset($_POST['tambah'])) {
    ...
    // Proses untuk menambah kategori ke database
...
<head>
    ...
    <title>Tambah Kategori Buku - Perpustakaan Digital</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <!-- Menampilkan pesan setelah proses tambah kategori -->
                    ...
                    <form method="post" action="">
                        ...
                        <button type="submit" name="tambah" class="btn btn-success mt-3">Tambah Kategori</button>
